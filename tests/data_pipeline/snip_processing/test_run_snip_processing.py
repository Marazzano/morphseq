...
from data_pipeline.segmentation.backends.sam2_video.fake_predictor import (
    FakePredictor,
    segment_one_well_fake,
)
from data_pipeline.segmentation.sam2_video.model_loader import Sam2VideoModelConfig
from data_pipeline.segmentation.sam2_video.run_sam2_video import (
    Sam2WellInput,
...
def _make_frame_masks(frame_inventory: pd.DataFrame) -> pd.DataFrame:
    ...
    with patch(
        "data_pipeline.segmentation.sam2_video.run_sam2_video.load_sam2_video_model",
