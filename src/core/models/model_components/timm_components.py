...
from src.core.models.model_components.timm_helpers import vit_resize, swin_resize
from src.core.models.model_components.arch_configs import TimmArchitecture
...
class UniDecLite(nn.Module):
    ...
    def __init__(self, cfg: TimmArchitecture, enc_ch_last: int) -> None:
        ...
        if self.use_local_attn:
            from src.core.models.model_components.window_attention import WindowAttention
