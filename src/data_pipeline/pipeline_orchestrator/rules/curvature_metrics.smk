...
from data_pipeline.feature_extraction.curvature_metrics.contract import CURVATURE_TABLE_COLUMNS
shards = collect_well_shard_paths('{DATA_ROOT}', 'curvature_metrics', 'curvature_metrics', '{wildcards.experiment}')
concat_well_shards_to_file(shards, '{output.merged}', required_columns=CURVATURE_TABLE_COLUMNS, sort_columns=['experiment_id', 'well_id', 'snip_id'])
"
        """
