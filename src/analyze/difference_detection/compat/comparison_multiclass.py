"""
Multiclass group comparison functions for difference detection.

Extends binary classification framework to support N-class comparisons using
One-vs-Rest (OvR) AUROC with permutation-based null distributions.

Key functions:
- compare_groups_multiclass(): Run multiclass OvR AUROC-based comparison

Example
-------
>>> from morphseq.difference_detection import compare_groups_multiclass
>>>
>>> # Define groups
>>> groups = {
...     'CE': ce_ids,
...
def compare_groups_multiclass(
    ...
    """
    Compare multiple groups using One-vs-Rest AUROC classification.
