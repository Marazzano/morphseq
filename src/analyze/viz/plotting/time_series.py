"""
Generic plotting utilities for time series analysis.

This module provides flexible plotting functions for visualizing time-series
...
These functions are domain-agnostic and can be used for any time-series data
(trajectories, signals, measurements over time, etc.).
"""
