"""
Faceted plotting extension for multi-experiment analysis.

Extends plot_embryos_metric_over_time with faceting capability to create
...
# Import DTW and trajectory utilities
...
def _plot_single_group_on_axis(
    ...
    Helper function used by plot_embryos_metric_over_time_faceted.
    """
...
def plot_embryos_metric_over_time_faceted(
    ...
    """
    Plot embryo metric trajectories with faceting for multi-experiment comparison.
    ...
    df : pd.DataFrame
        ...
        Required columns: embryo_col, time_col, metric, color_by, facet_by
    ...
    facet_by : str, default='experiment_id'
    ...
    show_individual : bool, default=True
        If True, show individual embryo trajectories (light lines)
    ...
    Examples
    --------
    >>> # Compare genotypes across experiments
    >>> fig = plot_embryos_metric_over_time_faceted(
    ...     df_all,
    ...     color_by='genotype',
    ...     facet_by='experiment_id',
    ...     facet_ncols=3
    ... )
    """
    # Validate required columns
    required_cols = [metric, time_col, embryo_col, color_by, facet_by]
