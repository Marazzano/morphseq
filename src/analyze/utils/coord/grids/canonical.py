...
class CanonicalAligner:
    ...
    def _compute_back_direction(
        ...
        back_yx, back_debug = compute_back_direction(
            mask,
            yolk_mask,
            center_of_mass=self._center_of_mass,
            project_point_to_mask_in_disk=self._project_point_to_mask_in_disk,
            back_sample_radius_k=self.back_sample_radius_k,
        )
