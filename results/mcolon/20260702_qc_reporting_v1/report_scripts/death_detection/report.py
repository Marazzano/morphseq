"""death_detection report — mortality views at three grains. TIER-1 / worked example.
...
def _trace_with_flags() -> pd.DataFrame:
...
def build(output_dir: Path) -> list[Path]:
    ...
    experiment = plot_line(
        ...
        output_path=output_dir / "alive_embryos_experiment.png",
    ...
    curtain = plot_grouped_traces(
        ...
        output_path=output_dir / "mortality_curtain.png",
    ...
    death_time_hist = plot_metric_histogram(
        ...
        output_path=output_dir / "death_time_histogram.png",
