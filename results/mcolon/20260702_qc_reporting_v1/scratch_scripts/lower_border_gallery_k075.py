"""Ad-hoc: gallery of ALIVE-ONLY snips nearest the surface_area_qc LOWER band threshold,
with k_lower raised from 0.7 -> 0.75 (interim mitigation, see
docs/refactors/streamline-snakemake/target/specs/tech_debt/surface_area_qc_pose_confound.md).

0.75 is the smallest bump that flips both originally-flagged bad masks
(20250912_H04_e01_BF_t0020, 20250912_H05_e02_BF_t0016) to fail, at the empirical minimum
collateral (113 alive snips flip total at this k, per the k_lower sweep).
"""
...
SA_K_LOWER, SA_K_UPPER = 0.75, 1.4  # k_lower raised from 0.7 -> 0.75
...
border.to_csv(
    "results/mcolon/20260702_qc_reporting_v1/scratch_scripts/lower_border_snips_k075.csv", index=False
)
...
gallery = _render_band_page(
    ...
    title="surface_area_qc (ALIVE ONLY) -- k_lower=0.75 (raised from 0.7), area in mm^2",
    output_path=Path("results/mcolon/20260702_qc_reporting_v1/scratch_scripts/lower_border_gallery_k075.png"),
    n_per_band=16,
    band_cols=4,
)
print("saved", gallery)
