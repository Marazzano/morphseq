...
`src.data_pipeline.segmentation._archive.video_generation.video_config`.
"""
...
try:
    from src.data_pipeline.segmentation._archive.video_generation.video_config import (  # noqa: F401
        COLORBLIND_PALETTE,
        OVERLAY_COLORS,
        VideoConfig,
        get_color_cycle,
