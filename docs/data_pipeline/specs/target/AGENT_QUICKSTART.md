...
```
docs/data_pipeline/specs/target/current_state_and_next_steps.md
```
...
```
docs/data_pipeline/specs/target/front_half_reorg_roadmap.md
```
...
```
docs/data_pipeline/specs/target/specs/pipeline_file_philosophy.md
```
