...
**Plan doc:** `docs/data_pipeline/specs/target/specs/source_tree_stage_alignment.md` —
...
- Fix `docs/data_pipeline/specs/target/specs/output_tree_doctrine.md`'s river prose:
